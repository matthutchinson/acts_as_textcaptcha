...
{<img src="http://travis-ci.org/matthutchinson/acts_as_textcaptcha.png" alt="Travis Build Status" align="absmiddle"/>}[http://travis-ci.org/#!/matthutchinson/acts_as_textcaptcha] - thanks to {Travis CI}[http://travis-ci.org/#!/matthutchinson/acts_as_textcaptcha]
